...
## 2024-06-26 - Accessible Form Feedback & Indicators
**Learning:** Enhancing forms with both visual (asterisks, spinners) and semantic (aria-required, aria-live) feedback significantly improves usability for all users, including those using assistive technologies.
**Action:** Always include visible and semantic required indicators, helpful placeholders, and clear loading/success states for all interactive forms.
